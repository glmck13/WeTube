...
exten => 7000,n,GotoIf($["${CALLERID(num)}" = "5551212"]?ivr)
exten => 7000,n,Dial(PJSIP/6100&PJSIP/6200)
exten => 7000,n,Hangup
;exten => 7000,n,AGI(ttsagi.py,"Enter extension followed by the pound key.",/var/lib/asterisk/sounds/myapp/extension.mp3)
exten => 7000,n(ivr),Set(VOLUME(TX)=2)
exten => 7000,n,Playback(myapp/extension)
exten => 7000,n,Read(MYCHOICE,beep,,t(*#))
exten => 7000,n,Goto(from-pstn-custom,${MYCHOICE},1)
...
exten => 222,n,GotoIf($["${READSTATUS}" != "OK"]?msgbye)
